...
#    Video Number: #63
# Data Files Used: 63a_Data_File.csv, and 63b_Data_File.csv
#
# Load data file (Source: www.weather.com)
#
# Read in weather file
weather <- read.csv("63a_Data_File.csv", header = TRUE, sep = ",")
print(weather)
#
wind <- read.csv("63b_Data_File.csv", header = TRUE, sep = ",")
print(wind)
#
